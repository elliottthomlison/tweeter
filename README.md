...
Tweeter is a simple, single-page Twitter clone. Tweeter was built in order to practice HTML, CSS, JS, jQuery and Ajax front-end skills, and NodeJS, Express and MongoDB back-end skills.
